...
* Allow engaged prediction-book users to contribute changes (predictionbook)
* Allow us to keep prediction-book deployment / setup information safe (predictionbook-deploy)
...
h3. Configure deploy repository with remote public repository
...
Push changes to deploy remote repository
